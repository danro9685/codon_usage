...
print(mean(dataset_mut)) # 0.2662217
print(mean(dataset_alt)) # 0.2556792
print(median(dataset_mut)) # 0.25
print(median(dataset_alt)) # 0.21
print(fivenum(dataset_mut)) # 0.05 0.13 0.25 0.40 0.73
print(fivenum(dataset_alt)) # 0.07 0.18 0.21 0.30 0.73
print(t.test(dataset_mut,dataset_alt)$p.value) # 2.616063e-75
