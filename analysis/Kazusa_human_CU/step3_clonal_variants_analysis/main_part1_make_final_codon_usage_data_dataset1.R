# load data
load("results/dataset1/annotations.RData")
load("results/dataset1/codon_usage_information.RData")
load("results/dataset1/human_cu.RData")
load("results/dataset1/sars_cov2_fasta.RData")

# DATA 1: consider only unique variants for first half of timeline
codon_usage_information_selected = codon_usage_information[which(as.Date(codon_usage_information[,"DATE"])<=as.Date("2020-06-15")),]
