# load data
load("results/dataset3/annotations.RData")
load("results/dataset3/codon_usage_information.RData")
load("results/dataset3/human_cu.RData")
load("results/dataset3/sars_cov2_fasta.RData")
...
dataset3_unique_variants = data.frame(RCU=RCU_val,VF=VF,VARIANT=VARIANT,VARIANT_REDUCED=VARIANT_REDUCED)
...
reduced_variants[which(reduced_variants=="T>G")] = "A>C/T>G"
VARIANT_REDUCED = reduced_variants
dataset3_variants = data.frame(RCU=RCU_val,VF=VF,VARIANT=VARIANT,VARIANT_REDUCED=VARIANT_REDUCED)

# save results
save(dataset3_unique_variants,file="final_dataset/dataset3_unique_variants.RData")
save(dataset3_variants,file="final_dataset/dataset3_variants.RData")
