...
dataset1_unique_variants = data.frame(RCU=RCU_val,VF=VF,VARIANT=VARIANT,VARIANT_REDUCED=VARIANT_REDUCED)
...
reduced_variants[which(reduced_variants=="T>G")] = "A>C/T>G"
VARIANT_REDUCED = reduced_variants
dataset1_variants = data.frame(RCU=RCU_val,VF=VF,VARIANT=VARIANT,VARIANT_REDUCED=VARIANT_REDUCED)

# save results
save(dataset1_unique_variants,file="final_dataset/dataset1_unique_variants.RData")
save(dataset1_variants,file="final_dataset/dataset1_variants.RData")
